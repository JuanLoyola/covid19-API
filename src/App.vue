<template>
  <div class="container">
    <div class="row mt-5">
      <div class="col">
        <h1 class="text-center">COVID-19 Información</h1>
      </div>
    </div>
    ...
    <div class="row mt-5" v-if="arrHospitalized.length > 0">
      <div class="col">
        <h2 class="text-center">Hospitalizados</h2>
        <line-chart
    ...
    <div class="row mt-5" v-if="arrInIcu.length > 0">
      <div class="col">
        <h2 class="text-center">En cuidados intensivos</h2>
        <line-chart
          :chartData="arrInIcu"
          :options="chartOptions"
    ...
    <div class="row mt-5" v-if="arrOnVentilators.length > 0">
      <div class="col">
        <h2 class="text-center">Con respirador</h2>
        <line-chart
    ...
    <div class="row mt-5 mb-5">
      <div class="col">
        <h2 class="text-center">Muertes</h2>
        <line-chart
